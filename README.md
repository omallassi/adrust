...
The current code line is tested on `MacOs / Rust 1.39` and build with `cargo`. [Travis CI](https://travis-ci.org/omallassi/adrust/builds) will build on `Linux / Windows` and `Rust 1.39` / `Rust 1.40`
